    ...
    <Wrapper>
      <RotateWrapper>
        ...
        <LeftPanel>
          ...
          <LeftPanelBody>
            “A day in crypto is a year in the off-chain world”. Crypto moves
            fast, tons of new projects and concepts come out everyday. How
            should we keep updated and get a grasp of innovative ideas? DAOki
            provides a way for crypto people to get access to structured
            knowledge and concepts within several clicks and auto-reference
            links.
          </LeftPanelBody>
          <BottomLineWrapper>
            <BottomLineCircle />
          ...
          <IconTextContainerWrapper>
            ...
            <IconTextWrapper>
              ...
              <IconTextBody>
                ...
                cross-reference links. Easy for both readers and editors to
                access related background content for better demonstration of
                complicated ideas
              </IconTextBody>
              <IconTextBody>
                <strong>[Distinctions]</strong> Based on the expertise and
                feedback from the user community, DAOki will rank different
                pages for easier usages.
              </IconTextBody>
            </IconTextWrapper>
          </IconTextContainerWrapper>
          <IconTextContainer
