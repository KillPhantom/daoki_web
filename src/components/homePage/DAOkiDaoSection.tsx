    ...
    <SectionWrapper>
      ...
      >
        ...
        <ContentCardBody>
          ...
          of tool-building, subDAO- creating, etc. The exclusive NFT will record
          donors' on-chain contributions and act as their credit/reputation
          references in DAOki.
        </ContentCardBody>
        <ContentCardBody>
          <strong>[Sower]</strong> People responsible for executions in DAOki.
          Sowers will be delegated by Donors and get corresponding subNFT. They
          distribute funds from donors for encouraging content creation and
          related work. subNFT will serve as their performance record for their
          future evaluations and supervision by donors.
        </ContentCardBody>
        <ContentCardBody>
          <strong>[Builder]</strong> Anyone who contributes to DAOki. Just like
          the other two roles, Builders will get their Builder NFT as their
          proof of contributions. Builders can either take tasks posted by
          Sowers or contribute in any way they like.
        </ContentCardBody>
        <ContentCardBody>
